...
/**
 * Aggregator Agent collects production and consumption data, computes the remaining energy, and
 * broadcasts allocation messages.
 */
        ...
        new CyclicBehaviour(this) {
          ...
          public void action() {
            ...
            if (tickMsg != null) {
              ...
              log(
                  "Tick received. Total Production: "
                      + totalProduction
                      + ", Total Consumption: "
                      + totalConsumption
                      + ", Remaining: "
