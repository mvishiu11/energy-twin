...
/**
 * OrchestratorAgent is responsible for broadcasting simulation tick messages to all subscribed agents.
 * It creates a tick topic using JADE's TopicManagementHelper and sends ticks only when the simulation is active.
 */
public class OrchestratorAgent extends SpringAgent {
    ...
    protected void onAgentSetup() {
        ...
        tickBroadcastBehaviour = new TickBroadcastBehaviour(this, simulationControlService.getTickIntervalMillis(), tickTopic, simulationControlService);
